          ...
          >
            ...
            <div className="grid grid-cols-3 gap-8">
              <div>
                ...
                <div className="text-sm text-muted-foreground">{t.infrastructure.stats.dataCenters}</div>
              </div>
              <div>
                <div className="text-4xl lg:text-5xl font-display mb-2">99.99%</div>
                <div className="text-sm text-muted-foreground">{t.infrastructure.stats.uptime}</div>
              </div>
              <div>
                <div className="text-4xl lg:text-5xl font-display mb-2">&lt;50ms</div>
                <div className="text-sm text-muted-foreground">{t.infrastructure.stats.latency}</div>
              </div>
            </div>
          </div>
          ...
          >
            <div className="border border-foreground/10">
              ...
              <div className="px-6 py-4 border-b border-foreground/10 flex items-center justify-between">
                <span className="text-sm font-mono text-muted-foreground">{t.infrastructure.edgeNetwork}</span>
