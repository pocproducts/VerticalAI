...
export function DevelopersSection() {
  const { t } = useLanguage();
  const tabLabels = [t.developers.tabs.install, t.developers.tabs.initialize, t.developers.tabs.deploy];
  const codeExamples = codeExampleMeta.map((c, i) => ({ ...c, label: tabLabels[i] }));
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-6xl font-display tracking-tight mb-8">
              ...
              <br />
              <span className="text-muted-foreground">{t.developers.titleLine2}</span>
            </h2>
