            ...
            <div className="max-h-[60vh] overflow-y-auto">
              ...
              {filteredConversations.length === 0 && query.trim() && (
                <div className="p-8 text-center">
                  ...
                  <div className="mt-4 text-lg font-medium text-zinc-900 dark:text-zinc-100">Sin resultados</div>
              ...
              {!query.trim() && conversations.length === 0 && (
                <div className="p-8 text-center">
                  <div className="text-lg font-medium text-zinc-900 dark:text-zinc-100">No hay conversaciones</div>
                  <div className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">Empezá un chat nuevo</div>
                </div>
              )}
            </div>
          </motion.div>
